...
if [ "$benchmark" = "MMVP" ]; then
    benchmark_dir="/data/chatgpt/notebooks/mnulli/thesis/MMVP/data"
    eval_file=/data/chatgpt/notebooks/mnulli/thesis/cambrian/eval/eval/mmvp/mmvp_eval.py
    test_file=/data/chatgpt/notebooks/mnulli/thesis/cambrian/eval/eval/mmvp/mmvp_test.py
fi    
