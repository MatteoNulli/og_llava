...
MODEL_NAME="e-Llama-3_1-8B-Instruct-DPO-epoch-1"
DATA_DIR=/mnt/nushare2/data/mnulli/verified_conversations/finetuningdata
# DATA_DIR=/mnt/nushare2/data/vorshulevich/vlm_data/

IMG_DIR='None' 

SAVE_DIR=/mnt/nushare2/data/mnulli/finetuning/from-blip-pretrain/${MODEL_NAME}-lora-15m-fash-short-us_set-llava-mix-todel

MODEL_DIR=/mnt/nushare2/data/pflorek/models/${MODEL_NAME}
