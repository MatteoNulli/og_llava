...
# from ezcolorlog import root_logger as logger ## replaced logger.warning --> print because of no ezcolorlog support
...
class ProcessorWrapper:
    ...
    def preprocess(self, image, return_tensors='pt'):
        ...
        # if hasattr(self._transforms, 'image_processor_type'):
        #     output = [self._transforms(image)]
        # else:
...
class BaseVisionTower(nn.Module):
    ...
    def forward(self, images):
        if type(images) is list:
            ...
            # print('images in base encoder', images.device)
