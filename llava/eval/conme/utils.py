...
def t2i_score(sample, multiple_choices, correct_choice, t2i_model):
    scores = dict()
    ...
    )  # compare the scores of the two captions
    ...
    def __init__(
        ...
        **kwargs,
        ...
        tokenizer, model, self.image_processor, context_len = load_pretrained_model(
            pretrained, None, self.model_name, device_map=self.device
        )
